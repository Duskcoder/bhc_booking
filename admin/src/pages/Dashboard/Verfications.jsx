...
import Pdf from "../../assets/SALE APPLICATION FORM FOR A NON-SITTING TENANT (INDIVIDUAL) (1).pdf"
...
function Verification() {
  ...
  const columns = [
    ...
    { name: "Vertification Status", selector: (row) => row.status, sortable: true },
          ...
          <div className="showuser-model">
            <div className="d-flex flex-column showuser-whole">
              ...
              <div className="showuser-input-div mt-5">
                ...
                <div className='mt-2'>
                  <img src={selectedDetail.image} width="40%" alt="property" />
                </div>
                <div className="text-center mt-3">
                  <button className="button_register" onClick={handleDownloadPDF}>
                    Download PDF
                  </button>
                </div>
              </div>
