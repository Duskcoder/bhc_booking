...
function Maintenance() {
    ...
    const details = [
        { id: 1, name: "yogesh", email: "yogesh@gmail.com", mobile: "1111111111", active: "pending" },
        { id: 2, name: "gokul", email: "gokul@gmail.com", mobile: "2222222222", active: "rejected" },
        { id: 3, name: "maha", email: "maha@gmail.com", mobile: "2222222222", active: "success" }
    ];
    ...
    const data = details.map((detail) => ({
        ...
        active: (
            <div
                style={{
                    background: detail.active === "pending" ? "orange" :
                        detail.active === "rejected" ? "red" :
                            detail.active === "success" ? "green" : "gray",
                    height: "20px",
                    borderRadius: "10px",
                    padding: "20px",
                    display: "flex",
        ...
        action: (
            <div>
                <button onClick={() => handleClick(detail.id)}>{Icons.eye.active}</button>
            </div>
        )
    }));
                    ...
                    <div className="showuser-model">
                        <div className="d-flex flex-column showuser-whole">
                            <div className="d-flex justify-content-between mt-4">
                                ...
                                <button className="me-3" onClick={() => setOpen(false)}>{Icons.close.default}</button>
                            </div>
                            <div className="showuser-input-div mt-5">
                                <form className="w-100">
                                    ...
                                    <label htmlFor="mobile" className="fw-bold">Status</label>
